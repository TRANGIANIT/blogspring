...
%>
	...
	<div id="container">
		<div id="content">
			<!---->
			<div id="newPost">
				<h2 class="focus">Tìm thấy <%=request.getAttribute("totalPosts") %> kết quả phù hợp với: "<%=request.getParameter("q")%>"</h2>
				...
				<%
					if(numPages > 1){
						...
						out.println("<ul>");
						if(currentPage != 1){
							out.println("<li><a href='"+request.getContextPath()+"/search?q="+ request.getParameter("q")+"&p="+(currentPage-1)+"'>Pre</a></li>");
						}
						for(int i=1; i<=numPages; i++){
							if(i==currentPage){
								out.println("<li><span>"+i+"</span></li>");
							}else{
								out.println("<li><a href='"+request.getContextPath()+"/search?q="+ request.getParameter("q")+"&p="+i+"'>"+i+"</a></li>");
							}
						}
						if(currentPage != numPages){
							out.println("<li><a href='"+request.getContextPath()+"/search?q="+ request.getParameter("q")+"&p="+(currentPage+1)+"'>Next</a></li>");
						}
						out.println("</ul>");
						out.println("</div>");
					}
